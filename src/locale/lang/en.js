export default {
  ...
  settings: {
    ...
    equalizer: {
      ...
      description: 'Shape playback with presets or adjust each band manually.',
      preset: 'Preset',
      reset: 'Reset',
      presets: {
        flat: 'Flat',
    ...
    cacheManagement: {
      ...
      total: '{item} cached items ({size})',
      refresh: 'Refresh',
      clearAll: 'Clear all cache',
      clearType: 'Clear',
      itemCount: '{count} items',
      clearedAll: 'All cache cleared',
      clearedType: 'Cache cleared',
      types: {
        trackSources: 'Song files',
        trackDetail: 'Song details',
        lyric: 'Lyrics',
        album: 'Albums',
      },
    },
